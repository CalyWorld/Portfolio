  ...
  const projects = [
    {
      ...
      githubUrl: "https://github.com/CalyWorld/Hospital-management",
    },
    {
      name: "Blog API",
      description:
      ...
      skills: ["React", "Typescript", "MongoDB", "Express", "Node"],
      githubUrl: "https://github.com/CalyWorld/Blog-API",
    },
    {
      name: "ChatGPT Clone",
      description:
      ...
      url: "https://chatgpt-clone-u74b4kgv7-calyworld.vercel.app/",
    },
    {
      name: "Where's Waldo",
      description:
        "leveraging GPT 3.5 LLM to make prompts, store chats, delete chats and integrating it with firebase authentication and cloudeStore",
      skills: ["React", "Typescript", "Firebase"],
      url: "https://calyworld.github.io/Where-s-Waldo-A-Photo-Tagging-App-/#/Game",
    },
  ];
    ...
    <>
      ...
      <div className="flex flex-col gap-16 max-w-2xl">
        ...
        <div className="education">
          ...
          <div className="education-item sm:flex flex-col sm:items-center lg:flex lg:flex-row gap-4 p-2 shadow-lg bg-[#111827] rounded-md">
            <img
              src={education.logo}
              alt="school-logo"
              className="w-12 h-12 mx-auto"
            />
            <div className="flex sm:flex-col text-center lg:flex-row  w-full justify-between">
              <div>
                <p className="text-lg font-semibold text-[#9ca3af]">
                  {education.school}
                </p>
